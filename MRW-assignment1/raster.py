...
def point_in_shape(pt: Point, shape: Shape, verbose=False):
    ...
    match shape:
        ...
        case Line():
            ...
            # construct 2 triangles using specific rectangle vertex groups
            ...
            # check if the point is in either of the constructed triangles
...
def get_rect_from_line(shape: Line) -> List[Point]:
    ...
    # apply the x and y shift to the line's endpoint to find the vertices of the rectangle
